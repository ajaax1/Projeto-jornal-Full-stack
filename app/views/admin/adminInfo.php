...
<section style="display: flex; flex-direction:column;">
    ...
    <table class="table table-dark">
        ...
        <tbody>
            <?php
            foreach (SelectAdmins::SelectAdmins() as $admin) {
                echo('
                    <tr>
    ...
    <div style="display: flex;flex-direction: column; align-items:center;">
        <div>
            ...
            ?>
            <p style="text-align:center;">Showing <?php echo $page ?> of <?php echo SelectAdmins::fullPage() ?> </p>
        </div>
        ...
        <div class="pagination" style="display:flex;align-items:center;justify-content:center;">
            ...
            <div class="page-numbers" style="display:flex;text-decoration:none;">
                ...
                $end = min(SelectAdmins::fullPage(), $currentPage + 3);
            ...
            <?php
             if (!isset($_GET['page-nr']) and SelectAdmins::fullPage()>1) {
            ?>
                <a style="display:flex;align-items:center;text-decoration:none;" href="?page-nr=2">
                    <span class="material-symbols-outlined">chevron_right</span>
                </a>
            <?php
            } elseif(!isset($_GET['page-nr']) and SelectAdmins::fullPage() == 1) {
            ?>
                <a style="display:flex;align-items:center;text-decoration:none;">
                    <span class="material-symbols-outlined">chevron_right</span>
                </a>
            <?php
            }elseif ($_GET['page-nr'] < SelectAdmins::fullPage()) {
            ?>
                <a style="display:flex;align-items:center;text-decoration:none;" href="?page-nr=<?php echo $_GET['page-nr'] + 1 ?>">
                    <span class="material-symbols-outlined">chevron_right</span>
                </a>
            ...
            ?>
            <a style="display:flex;align-items:center;text-decoration:none;" href="?page-nr=<?php echo SelectAdmins::fullPage()?>">
