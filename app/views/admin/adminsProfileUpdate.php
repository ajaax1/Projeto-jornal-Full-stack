...
<form method="POST" action="/admin/update">
    ...
    <div class="form-outline mb-2 d-flex" style="gap:1rem;">
        <input type="text" id="form3Example1cg" placeholder="<?php echo htmlspecialchars($_SESSION['name']) ?>"  name="name" class="form-control form-control-lg" />
        <input type="text" id="form3Example1cg" placeholder="<?php echo htmlspecialchars($_SESSION['name2']) ?>"  name="name2" class="form-control form-control-lg" />
    </div>
    
    <div class="form-outline mb-2">
        <input type="email" id="form3Example3cg" placeholder="<?php echo htmlspecialchars($_SESSION['email']) ?>"  name="email" class="form-control form-control-lg" />
    </div>
